...
##Damages with the baseline temperature
...
```
### Differences in Damages over time that arise form the pulse
```{r}
...
#we plug in this temperature to the damages function. We will use the warming_baseline temperature.
damages_50 <- predict(damages_model, list(warming = warming_50$warming_baseline, warming2=warming_50$warming_baseline^2))
damages_50 #this is the total cost of damages
```
...
#using the present value formula, we know that B= damages_50, and that B/r = Present Value.
